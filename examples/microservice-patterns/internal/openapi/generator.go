...
// Generator wraps the OpenAPI generator with microservice-specific configuration
type Generator struct {
	generator *openapi.Generator
	config    config.ServiceConfig
}

// NewGenerator creates a new OpenAPI generator for a specific service
func NewGenerator(cfg config.ServiceConfig) *Generator {
	return &Generator{
